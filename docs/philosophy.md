...
qingshan-skills is organized by failure mode, not by source framework.

## Source Failure Models
...
The result is not a lighter copy of any source project. It is a smaller method for doing software engineering work across features, bugs, refactors, performance, deployment, documentation, tooling, and stability.
