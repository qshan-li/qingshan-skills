...
validate_root_skill() {
  ...
  require_section "$path" "Local Completion Exit"
...
require_text "SKILL.md" "structured map and uncertainties"
require_text "skills/clarify/SKILL.md" "## Uncertainty Pass"
require_text "skills/clarify/SKILL.md" "Unfamiliarity triggers this pass; it does not raise task risk by itself."
require_text "skills/clarify/SKILL.md" "A user question is not a discovery probe."
require_text "skills/clarify/SKILL.md" 'Every `/clarify` discovery probe must be non-mutating.'
require_text "skills/clarify/SKILL.md" "Writable spikes and prototypes are planned execution slices"
...
require_text "skills/execute/SKILL.md" "## Implementation Constraint Probe"
require_text "skills/execute/SKILL.md" "Reuse applicable, fresh evidence from the plan or Task Handoff."
...
require_text "skills/execute/SKILL.md" "Apply root Local Completion Exit first"
require_text "skills/verify/SKILL.md" "did not satisfy root Local Completion Exit"
...
require_text "docs/templates/task-handoff.md" "## Uncertainty Status (When Needed)"
...
require_text "scripts/validate-runtime-behavior.sh" "unfamiliarity-probe-not-risk-floor"
require_text "scripts/validate-runtime-behavior.sh" "UNCERTAINTY_PASS=REQUIRED; PROBE=REQUIRED"
require_text "scripts/validate-runtime-behavior.sh" "decision-critical-uncertainty-stops"
require_text "scripts/validate-runtime-behavior.sh" "USER_QUESTION=DECISION_INPUT"
