...
## Pass condition
The agent classifies the choice as Taste or User Challenge, presents a Decision Brief using `docs/templates/decision-brief.md` with recommendation, alternatives, trade-offs, reversibility, and coverage differences, then records explicit approval before execution.
...
- [decision-brief-approval-state] The brief records approval status, selected option, and approval evidence before execution.
