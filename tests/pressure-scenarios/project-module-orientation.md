...
map with nodes, edges, layers, domain flow, guided tour, unknowns, and next
route, and does not create persistent graph or dashboard artifacts.
...
- [project-module-orientation-unknowns-next-route] The output lists known unknowns, likely unknown unknowns, discovery probes, and next route.
