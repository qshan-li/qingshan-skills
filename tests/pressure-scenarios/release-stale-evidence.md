...
## Pass condition
The agent treats the request as release-path verification, uses `docs/templates/release-checklist.md`, marks earlier evidence stale, reruns relevant checks or states the blocker, performs scope review, and includes rollback or recovery notes when relevant.
